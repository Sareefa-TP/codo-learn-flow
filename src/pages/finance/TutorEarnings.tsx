...
const mockEarnings: TutorEarning[] = [
    { id: 1, date: "03 Mar 2026", tutor: "Meera Nair", batch: "Batch Alpha – Jan 2026", sessions: 20, ratePerSession: 1500, status: "Unpaid" },
    { id: 2, date: "03 Mar 2026", tutor: "Suresh Kumar", batch: "Batch Beta – Feb 2026", sessions: 18, ratePerSession: 1500, status: "Paid" },
    { id: 3, date: "03 Mar 2026", tutor: "Lakshmi Iyer", batch: "Batch Gamma – Mar 2026", sessions: 22, ratePerSession: 1500, status: "Unpaid" },
    { id: 4, date: "28 Feb 2026", tutor: "Meera Nair", batch: "Batch Beta – Feb 2026", sessions: 16, ratePerSession: 1500, status: "Paid" },
    { id: 5, date: "28 Feb 2026", tutor: "Suresh Kumar", batch: "Batch Alpha – Jan 2026", sessions: 20, ratePerSession: 1500, status: "Paid" },
    { id: 6, date: "28 Feb 2026", tutor: "Ravi Shankar", batch: "Batch Gamma – Mar 2026", sessions: 24, ratePerSession: 1800, status: "Unpaid" },
    { id: 7, date: "20 Feb 2026", tutor: "Lakshmi Iyer", batch: "Batch Alpha – Jan 2026", sessions: 18, ratePerSession: 1500, status: "Paid" },
    { id: 8, date: "20 Feb 2026", tutor: "Ravi Shankar", batch: "Batch Beta – Feb 2026", sessions: 20, ratePerSession: 1800, status: "Paid" },
    { id: 9, date: "15 Feb 2026", tutor: "Meera Nair", batch: "Batch Gamma – Mar 2026", sessions: 22, ratePerSession: 1500, status: "Unpaid" },
    { id: 10, date: "15 Feb 2026", tutor: "Suresh Kumar", batch: "Batch Gamma – Mar 2026", sessions: 20, ratePerSession: 1500, status: "Paid" },
    { id: 11, date: "10 Feb 2026", tutor: "Ravi Shankar", batch: "Batch Alpha – Jan 2026", sessions: 18, ratePerSession: 1800, status: "Paid" },
    { id: 12, date: "05 Feb 2026", tutor: "Lakshmi Iyer", batch: "Batch Beta – Feb 2026", sessions: 16, ratePerSession: 1500, status: "Unpaid" },
];

// ─── Helpers ──────────────────────────────────────────────────────────────────

const fmt = (n: number) => `₹${n.toLocaleString("en-IN")}`;
const amount = (r: TutorEarning) => r.sessions * r.ratePerSession;
...
const TutorEarnings = () => {
    ...
    const tutorCount = useMemo(
        () => new Set(mockEarnings.map(r => r.tutor)).size,
        []
    );
    ...
    const filtered = useMemo(() => {
        ...
        return mockEarnings.filter(r => {
            const matchSearch = !q || r.tutor.toLowerCase().includes(q);
            ...
            <div className="animate-fade-in space-y-6 max-w-7xl mx-auto pb-10">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">
                        Session-based earnings for all tutors across batches.
                    </p>
                </div>
                            ...
                            <table className="w-full text-sm">
                                <thead>
                                    <tr className="border-b border-border/50 bg-muted/30">
                                        ...
                                        <th className="text-right px-4 py-3 font-medium text-muted-foreground">Rate / Session</th>
                                    ...
                                    {filtered.length === 0 ? (
                                        ...
                                        filtered.map(r => (
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-3 font-medium">{r.tutor}</td>
                                                <td className="px-4 py-3 text-muted-foreground whitespace-nowrap">{r.batch}</td>
                                                <td className="px-4 py-3 text-center text-muted-foreground">{r.sessions}</td>
                                                <td className="px-4 py-3 text-right text-muted-foreground">{fmt(r.ratePerSession)}</td>
