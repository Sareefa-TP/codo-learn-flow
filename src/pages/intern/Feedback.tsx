...
interface FeedbackEntry {
  id: string;
  type: "to_coordinator" | "from_coordinator";
  author: string;
  rating?: number;
  message: string;
  date: string;
...
const mockFeedback: FeedbackEntry[] = [
  {
    id: "1",
    type: "from_coordinator",
    author: "Sarah Williams",
    rating: 5,
    message: "Excellent progress on the Dashboard project. Your attention to detail in the UI implementation is impressive.",
    date: "2024-03-25",
    status: "Read"
  },
  {
    ...
    author: "Sarah Williams",
    rating: 4,
    message: "Good work on the Weekly Report. I noticed some areas in the technical documentation that could be more concise.",
    date: "2024-03-24",
    status: "Read"
  },
  {
    ...
    author: "You",
    rating: 5,
    message: "Thank you for the detailed feedback on my dashboard implementation. It was very helpful!",
    date: "2024-03-20"
  }
];
...
const InternFeedback = () => {
  ...
  const [activeTab, setActiveTab] = useState("to-coordinator");
  ...
  const tabMapping: Record<string, FeedbackEntry["type"]> = {
    "to-coordinator": "to_coordinator",
    "from-coordinator": "from_coordinator",
  };
  ...
  const handleSubmit = () => {
    ...
    toast.success(`Feedback sent to coordinator successfully`);
  };
