...
const initialSubmissions: Submission[] = [
    ...
    },
    {
        ...
        coordinatorFeedback: "Excellent work! Clean code and well-documented endpoints.",
        files: [
    ...
    },
    {
        ...
        coordinatorFeedback: "The schema looks good overall, but the user_roles table needs normalization. Please revise and resubmit.",
        files: [
    ...
    },
    {
        ...
        coordinatorFeedback: "The mockups do not follow the design system specified in the brief. Please start over with the provided component library.",
        files: [
...
const CoordinatorTaskReviews = () => {
    ...
    const openReview = (sub: Submission) => {
        setActive(sub);
        setFeedback(sub.coordinatorFeedback ?? "");
        setReviewOpen(true);
    };
    ...
    const applyDecision = (newStatus: ReviewStatus) => {
        ...
        setSubmissions(prev => prev.map(s =>
            s.id === active.id ? { ...s, status: newStatus, coordinatorFeedback: feedback } : s
        ));
                    ...
                    {active && (
                        <>
                            ...
                            <div className="p-6 overflow-y-auto max-h-[65vh] space-y-6">
                                ...
                                {/* ── Section 3: Coordinator Feedback ── */}
                                <div>
...
export default CoordinatorTaskReviews;
