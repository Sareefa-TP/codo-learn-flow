...
import {
    Plus, Search, Eye, Edit, Trash2, Users,
    AlertCircle, CheckCircle2, Clock, FileText, UploadCloud
} from "lucide-react";
...
const CoordinatorTasks = () => {
    ...
    const handleViewTask = (task: Task) => { 
        navigate(`/coordinator/tasks/${task.id}`);
    };
        ...
        <div className="p-6 overflow-y-auto max-h-[70vh] space-y-5">
            ...
            <div className="space-y-2">
                ...
                <div className={`border-2 border-dashed rounded-xl p-6 text-center cursor-pointer transition-colors ${isDragging ? "border-primary bg-primary/10" :
                    ...
                    onClick={() => document.getElementById("coordinator-task-upload")?.click()}
                ...
                >
                    ...
                    <Input id="coordinator-task-upload" type="file" className="hidden"
