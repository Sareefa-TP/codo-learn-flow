...
const initialReports: WeeklyReport[] = [
    ...
    },
    {
        ...
        files: [],
        mentorFeedback: "Excellent work Priya! Clean code and well-documented. Keep it up.",
    },
    {
        ...
        mentorFeedback: "Good start Sneha! The report needs more detail in the Work Summary section. Also please elaborate on what specific challenges you resolved, not just what was unclear.",
    },
    {
...
const MentorWeeklyReports = () => {
    ...
    const applyDecision = (newStatus: ReportStatus) => {
        ...
        setReports(prev => prev.map(r =>
            r.id === active.id ? { ...r, status: newStatus, mentorFeedback: feedback } : r
        ));
...
export default MentorWeeklyReports;
