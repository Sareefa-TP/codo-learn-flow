...
const AlertDialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Content> & { variant?: "default" | "finance" }
>(({ className, variant = "default", ...props }, ref) => {
  const isFinance = variant === "finance";
  
  return (
    <AlertDialogPortal>
      <AlertDialogOverlay className={cn(isFinance && "backdrop-blur-md bg-black/40")} />
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          ...
          isFinance ? "rounded-2xl shadow-[0_32px_64px_-12px_rgba(0,0,0,0.4)]" : "sm:rounded-lg shadow-lg",
          className,
        )}
        {...props}
      />
